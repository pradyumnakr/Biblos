        ...
        <div className="footer_main">
            ...
            <div className="tag_three">
                <div className="social_link">
                    ...
                    <Link to="/"><img src={require('../assets/images/footer/icons8-instagram-30.png')} alt=""/></Link>
                    <Link to="/"><img src={require('../assets/images/footer/icons8-twitter-30.png')} alt=""/></Link>
                </div>
            </div>
