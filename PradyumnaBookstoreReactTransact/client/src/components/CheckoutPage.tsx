...
function CheckoutPage()
{
   ...
   */
   ...
   const placeOrder =  async (customerForm: CustomerForm) =>  {
      ...
      const url = 'http://webdev.cs.vt.edu:8080/PradyumnaBookstoreReactTransact/api/orders';
   ...
   async function submitOrder(event:FormEvent) {
      ...
      if (!isFormCorrect) {
         ...
         if(orders) {
            ...
            orderDispatch({ type: OrderDetailTypes.UPDATE, orderDetails: orders });
          ...
          {isCartEmpty ? ( // Render message and button if cart is empty
             ...
             <div className="checkout-total-box">
                <div className="price-details">
                   ...
                   <p><span className="label">Tax:</span> <span className="value">${taxAmount.toFixed(2)}</span></p>
